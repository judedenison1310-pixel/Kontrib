    ...
    <div className="min-h-screen bg-gray-50 pb-20 sm:pb-0">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track your payment history and status across all groups.</p>
        </div>
              ...
              <div className="text-center py-12">
                {contributions.length === 0 ? (
                  <>
                    ...
                    <h3 className="text-xl font-medium text-gray-900 mb-2">No Contributions Yet</h3>
                    <p className="text-gray-600 mb-6">
                      You haven't made any contributions yet. Start by making your first payment.
                    </p>
                    <Link href="/make-payment">
                      <Button className="bg-nigerian-green hover:bg-forest-green">
                        <CreditCard className="h-4 w-4 mr-2" />
                  ...
                  <>
                    ...
                    <p className="text-gray-600">
                      No contributions match your current search and filter criteria.
                    </p>
                    <Button
                      variant="outline"
                      onClick={() => {
                ...
                {filteredContributions.map((contribution) => (
                  <div
                    ...
                    className={`p-4 border rounded-lg hover:bg-gray-50 cursor-pointer transition-colors ${
                      contribution.status === 'pending' ? 'border-orange-200 bg-orange-50/30' :
                      contribution.status === 'confirmed' ? 'border-green-200 bg-green-50/30' :
                      contribution.status === 'rejected' ? 'border-red-200 bg-red-50/30' :
                      'border-gray-200'
                    }`}
                  ...
                  >
                    ...
                    {contribution.adminNotes && (
                      <div className="mt-3 pt-3 border-t border-gray-200">
                        <p className="text-sm text-gray-600">
                          <span className="font-medium">Admin Notes:</span> {contribution.adminNotes}
                        </p>
                      </div>
                    )}
                  </div>
